...
public:
    ...
    {   	      // an enumerated value is chosen to
        BIT_0,        // provide some guarantee that a valid
...
public:
    ...
    bool getSense() {
        return polarity?digitalRead(pin):!digitalRead(pin);
    };
    uint setDebounce() {
        return debounceCount = debounce;
    };
    int decrementDebounce() {
